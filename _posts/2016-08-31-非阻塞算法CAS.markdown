...
![链表结构]({{site.baseurl}}/pic/CAS/linked-queue.png)
...
![链表结构－增加节点时的中间状态]({{site.baseurl}}/pic/CAS/linked-queue-2.png)
...
![链表结构－增加第一个节点时的中间状态]({{site.baseurl}}/pic/CAS/linked-queue-3.png)
